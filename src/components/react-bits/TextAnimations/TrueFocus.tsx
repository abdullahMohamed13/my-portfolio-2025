...
const TrueFocus: React.FC<TrueFocusProps> = ({
  ...
  const fallbackChildren = <span>True Focus</span>;
  const content = children ?? fallbackChildren;
  ...
  const childrenArray = Array.isArray(content) ? content : [content];
    ...
    }, [manualMode, animationDuration, pauseBetweenAnimations, childrenArray.length]);
