    ...
    return (
        <nav className="fixed bottom-0 left-0 w-full z-100 justify-center hidden md:flex">
            ...
            >
                ...
                {/* navbar-toggle-arrow  */}
                <button
                    className={`absolute right-0 border-neutral-700 bg-muted text-foreground rounded-xl shadow-lg p-2 transition-opacity duration-200 hover:bg-opacity-80 focus:outline-none z-10
